...
@interface AppDelegate ()<XLDrawerViewControllerDelegate>
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    ViewController *mainPage = [ViewController new];
    MenuViewController   *menuPage = [MenuViewController new];
    ...
    _drawerVC = [[XLDrawerViewController alloc] initWithMainViewController:navigationController menuViewController:menuPage];
